...
<div class="space-y-5">
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6 shadow">
        ...
        <p class="mt-1 text-sm text-slate-600">
            Selamat datang di Sikampus. Gunakan menu untuk mengelola data Civitas Akademik.
        </p>
    </div>
    ...
    <div class="lg:col-span-6">
        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow">
            <div class="text-xs font-semibold uppercase tracking-wider text-slate-500">Data</div>
            <h2 class="mt-1 text-lg font-semibold text-slate-900">Dosen</h2>
            <p class="mt-1 text-sm text-slate-600">
                Lihat daftar Dosen, cari berdasarkan nama/NIDN/Prodi, dan kelola data.
            </p>
